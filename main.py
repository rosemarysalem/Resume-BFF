...
from pdfminer3.pdfpage import PDFPage # by using we can convert pdf into html
...
digitalmarketing_course = [['Digital Marketing Tutorial For Beginners','https://www.youtube.com/watch?v=nU-IIXBWlS4'],
                  ['Digital Marketing Full Course','https://www.youtube.com/watch?v=nkNHn0VqVBA'],
                  ['The Complete Digital Marketing Course','https://www.udemy.com/course/learn-digital-marketing-course/?matchtype=e&msclkid=6756598c5bdb122ce8823d969e926457&utm_campaign=BG-LongTail_la.EN_cc.INDIA&utm_content=deal4584&utm_medium=udemyads&utm_source=bing&utm_term=_._ag_1214960761643255_._ad__._kw_digital+marketing+course_._de_c_._dm__._pl__._ti_kwd-75935386651374%3Aloc-90_._li_143956_._pd__._'],
                  ['Google Digital Marketing By Google','https://www.coursera.org/professional-certificates/google-digital-marketing-ecommerce']]
...
# to extract name ,degree, city, company ...
def pdf_reader(file):
...
# sql connector
connection = mysql.connector.connect(host='localhost', user='root',password="", database='cv')
#connection = mysql.connector.connect(host="localhost", user="root", password="", database="registration")
...
st.set_page_config(
   page_title="AI Resume Scaeener",
   page_icon='./Logo/cv.jpg',
)



# (Logo, Heading, Sidebar etc)
img = Image.open('./Logo/logo 3.jpg')
st.image(img)
st.sidebar.markdown("# Choose Something...")
activities = ["User", "Feedback", "About", "Admin"]
choice = st.sidebar.selectbox("Choose among the given options:", activities)
link = '<b>Built by <a href="https://dnoobnerd.netlify.app/" style="text-decoration: none; color: #021659;">Abinath 🤍</a></b>'
...
st.sidebar.markdown('''
    ...
    <p>Visitors <img src="https://counter9.stat.ovh/private/freecounterstat.php?c=t2xghr8ak6lfqt3kgru233378jya38dy" title="Free Counter" Alt="web counter" width="60px"  border="0" /></p> ''', unsafe_allow_html=True)
...
if choice == 'User':
    ...
    if pdf_file is not None:
        ...
        # resumeparser used for extracting information from resumes
        if resume_data:
            ...
            ds_keyword = ['tensorflow', 'keras', 'pytorch', 'machine learning', 'deep Learning', 'flask',
                            'streamlit','mysql','tableau','power bi','r','R language','R programming']
            web_keyword = ['react', 'django', 'node jS', 'react js', 'php', 'laravel', 'magento', 'wordpress',
                            'javascript', 'angular js', 'C#', 'Asp.net', 'flask','HTML','CSS']
            dm_keyword= ['seo','google ad words','google ad sense','semrush','google analysic','XLM Sit Map','social Media marketing']
            ...
            #### Data science recommendation
                if i.lower() in ds_keyword:
                    ...
                    recommended_skills = ['Data Visualization', 'Predictive Analysis', 'Statistical Modeling',
                                            ...
                                            'Streamlit','mysql','python','statistics','deep learning','power bi','tableau','excel']
                ...
                #### Digital Marketing
                elif i.lower() in dm_keyword:
                    print(i.lower())
                    reco_field = 'Digital Marketing'
                    st.success("** Our analysis says you are looking for Digital Marketing Jobs **")
                    recommended_skills = ['SEO','google ad words','google ad sense','semrush','google analysic','XLM Sit Map','social Media marketing','Facebook ads']
                    recommended_keywords = st_tags(label='### Recommended skills for you.',
                                                    text='Recommended skills generated from System',
                    ...
                    st.markdown(
                        ...
                        unsafe_allow_html=True)
                    # course recommendation
                    rec_course = course_recommender(digitalmarketing_course)
                    break
                ...
                #### For Not Any Recommendations
                    ...
                    reco_field = 'NA'
                    st.warning(
                        "** Currently our tool only predicts and recommends for Data Science, Web, Digital Marketing Development**")
...
###### CODE FOR ABOUT PAGE ######
    ...
    st.subheader("**About The Tool - AI RESUME SCANNER**")
    ...
    <p align="justify">
        Built by 
        <a href="https://dnoobnerd.netlify.app/" style="text-decoration: none; color: grey;">Abinath 🤍</a>
    </p>
    ''', unsafe_allow_html=True)
    ...
    if st.button('Login'):
        ...
        ## Credentials
        if ad_user == 'abinath' and ad_password == 'abinath':
